...
public class Tbuf {
    ...
    public static final int TBUF_ACCESS_SIZE = 8;
    public static final int TBUF_USER_ID_SIZE = 8;
    public static final int TBUF_GROUP_ID_SIZE = 8;
    public static final int TBUF_FILE_SIZE_SIZE = 12;
    public static final int TBUF_TIME_MODIFIED_SIZE = 12;
    public static final int TBUF_CHECKSUM_SIZE = 8;
    public static final int TBUF_NAME_SIZE = 100;


    public static final int TBUF_SIZE = 0x10A;

    private char[] name = new char[TBUF_NAME_SIZE];     //   0 0x000 Path name
    ...
    private char[] link = new char[TBUF_NAME_SIZE + 2]; // 156 0x09c Link flag + Link name + File type
