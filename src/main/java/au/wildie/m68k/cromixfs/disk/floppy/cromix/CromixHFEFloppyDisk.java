...
import au.wildie.m68k.cromixfs.disk.floppy.HFEFloppyImage;
...
public class CromixHFEFloppyDisk extends HFEFloppyImage {

    private final CromixFloppyInfo info;

    public CromixHFEFloppyDisk(HFEImage image, String formatLabel, PrintStream out) {
